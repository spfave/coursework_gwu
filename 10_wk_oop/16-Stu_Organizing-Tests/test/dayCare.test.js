...
describe("DayCare", () => {
  describe("Initialization", () => {
    it("should create an object with 'children' array, 'capacity' number, and 'ageLimit' number", () => {
      ...
      /**
       * Checks if the DayCare object is properly initialized
       */
  ...
  describe("addChild", () => {
    it("should add a child to the 'children' array", () => {
      ...
      /**
       * Arranges the test space with sample variables
       */
      ...
      /**
       * Acts on the dayCare object to add a child object
       */
      dayCare.addChild(child);

      // TODO: Add a comment describing the purpose of the following statements
      /**
       * Checks (Asserts) that the list of child object was incremented by 1
       * Checks if the added child is equal to the initialized child object
       */
    ...
    it("should not add a child over the 'ageLimit'", () => {
      ...
      // TODO: Add a comment describing the purpose of the following statement
      /**
       * Checks that no child is added if child age is over age limit
       */
    ...
    it("should not add a child if already at capacity", () => {
      ...
      /**
       * Sets the dayCare list of children object to specified child objects
       */
      dayCare.children = [
        new Child("Tammy", 1),
        new Child("Mark", 2),
      ...
      // TODO: Add a comment describing the purpose of the following statement
      /**
       * Checks that the dayCare list of children length property matches the number
       * of children defined
       */
    ...
    it("should throw an error if not provided a Child object as an argument", () => {
      ...
      // TODO: Add a comment describing the purpose of the following expression
      /**
       * Wrap code execution in a function so that thrown errors are returned
       */
      const cb = () => {
        const dayCare = new DayCare();
        dayCare.addChild();
      ...
      // TODO: Add a comment describing the purpose of the following statement
      /**
       * Insures proper error message is thrown
       */
